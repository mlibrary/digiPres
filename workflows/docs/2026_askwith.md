...
4. Continue to Generate File Tree.
...
6. If a **failed_checksums.txt** file was generated, investigate the results and restart from Prepare Media Directory.
